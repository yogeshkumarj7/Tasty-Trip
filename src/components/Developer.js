...
const Developer = () => {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className={`max-w-4xl mx-auto rounded-2xl shadow-xl p-8 mb-20 transition-colors duration-300 ${
        ...
        <div className="space-y-8">
          ...
          <div className="text-center mt-8">
            <a
              href="https://portfolio-self-six-85.vercel.app"
              target="_blank"
              className="inline-flex items-center space-x-2 text-teal-500 font-bold text-lg hover:underline"
            >
              <Link className="w-5 h-5" />
              <span>View My Portfolio</span>
            </a>
